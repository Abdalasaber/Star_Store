...
class HomeDescription extends StatefulWidget {
  ...
  const HomeDescription({Key? key, required this.productsModel})
      : super(key: key);

  @override
  State<HomeDescription> createState() => _HomeDescription();
}
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              DefaultText(
                                text: widget.productsModel.category ?? " null",
                                maxLines: 5,
                              ...
                              DefaultText(
                                text: widget.productsModel.title ?? " null",
                                maxLines: 5,
                                overflow: TextOverflow.ellipsis,
                                fontSize: 12.5.sp,
                                fontWeight: FontWeight.bold,
