...
class WomenClothingDescriptionScreen extends StatefulWidget {
  final WomenClothingModel womenClothingModel;

  const WomenClothingDescriptionScreen({
    Key? key,
    required this.womenClothingModel,
  }) : super(key: key);

  @override
  State<WomenClothingDescriptionScreen> createState() =>
      _WomenClothingDescriptionScreen();
}

class _WomenClothingDescriptionScreen
    extends State<WomenClothingDescriptionScreen> {
  ...
  void addToCart() {
    if (cubit.quantityCount > 0) {
      cubit.addToCart(
        womenItem: widget.womenClothingModel,
                      ...
                      children: [
                        Container(
                          ...
                          child: Hero(
                              ...
                              child: Image.network(
                                  "${widget.womenClothingModel.image}")),
                        ),
                        Padding(
                  ...
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              DefaultText(
                                text: widget.womenClothingModel.category ??
                                    " null",
                                maxLines: 5,
                              ...
                              DefaultText(
                                text:
                                    widget.womenClothingModel.title ?? " null",
                                maxLines: 5,
                                overflow: TextOverflow.ellipsis,
                                fontSize: 12.5.sp,
                                fontWeight: FontWeight.bold,
                              ...
                              Row(
                                ...
                                children: [
                                  DefaultText(
                                    text:
                                        '\$${widget.womenClothingModel.price ?? " null"}',
                                    maxLines: 5,
                                    overflow: TextOverflow.ellipsis,
                                    fontSize: 12.sp,
                                    fontWeight: FontWeight.bold,
                              ...
                              DefaultText(
                                text: widget.womenClothingModel.description ??
                                    " null",
                                maxLines: 20,
                                overflow: TextOverflow.ellipsis,
                                fontSize: 11.sp,
